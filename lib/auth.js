...
/**
 * Crea el valor de cookie firmado a partir del usuario que inició sesión.
 * Los permisos (grupos, roles) ya no viven en la cookie — se consultan en
 * cada request, así siempre están al día.
 */
...
/**
 * Verifica un token de cookie. Regresa { username } si es válido, o null si
 * no lo es (falsificado, corrupto, o no existe).
 */
